...
function wp_bootstrap_starter_scripts() {
    ...
    //Custo style for courses post type
    wp_enqueue_style( 'courses-style', get_template_directory_uri() . '/inc/assets/css/courses.css' );
...
/**
 * Load custom-types/courses.
 */
require get_template_directory() . '/post-types/courses.php';
require get_template_directory() . '/post-types/courses-tags.php';
